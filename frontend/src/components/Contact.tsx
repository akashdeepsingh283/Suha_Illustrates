...
const Contact: React.FC<ContactProps> = ({ isLoggedIn }) => {
  ...
  return (
    <section id="contact" style={{ backgroundColor: 'var(--white-warm)', padding: '7rem 0' }}>
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-16">
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', maxWidth: 500, margin: '1rem auto 0', lineHeight: 1.75, fontFamily: 'DM Sans, sans-serif', fontWeight: 300 }}>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          {/* Form */}
          <div style={{ backgroundColor: 'var(--vanilla)', border: '1px solid var(--sand)', borderRadius: 4, padding: '2.5rem' }}>
            <div className="flex items-center space-x-3 mb-8">
              <MessageSquare size={16} color="var(--tobacco)" />
              <h3 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '1.4rem', fontWeight: 600, color: 'var(--mahogany)' }}>Send a Message</h3>
            </div>
          ...
          <div className="space-y-6">
            {/* Contact info */}
            <div style={{ backgroundColor: 'var(--vanilla)', border: '1px solid var(--sand)', borderRadius: 4, padding: '2rem' }}>
              <h3 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '1.4rem', fontWeight: 600, color: 'var(--mahogany)', marginBottom: '1.5rem' }}>
                Contact Info
              </h3>
              <div className="space-y-5">
                {contactInfo.map((info, i) => (
                  <div key={i} className="flex items-center space-x-4">
                    <div style={{ width: 36, height: 36, backgroundColor: 'var(--mahogany)', borderRadius: 2, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                    ...
                    <div>
                      ...
                      <a href={info.link} style={{ color: 'var(--mahogany)', fontSize: '0.88rem', fontFamily: 'DM Sans, sans-serif', fontWeight: 400, textDecoration: 'none', transition: 'color 0.2s' }}
            ...
            <div style={{ backgroundColor: 'var(--vanilla)', border: '1px solid var(--sand)', borderRadius: 4, padding: '2rem' }}>
              <div className="flex items-center space-x-3 mb-5">
                ...
                <h3 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '1.4rem', fontWeight: 600, color: 'var(--mahogany)' }}>Availability</h3>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 14px', backgroundColor: 'rgba(181,158,125,0.1)', border: '1px solid var(--tobacco)', borderRadius: 2, marginBottom: '1rem' }}>
                <span style={{ fontSize: '0.82rem', color: 'var(--mahogany)', fontFamily: 'DM Sans, sans-serif' }}>Current Status</span>
                <span style={{ fontSize: '0.7rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--tobacco)', fontFamily: 'DM Sans, sans-serif' }}>Available</span>
              </div>
              <div style={{ fontSize: '0.82rem', color: 'var(--text-muted)', lineHeight: 2, fontFamily: 'DM Sans, sans-serif', fontWeight: 300 }}>
            ...
            {/* FAQ */}
            <div style={{ backgroundColor: 'var(--mahogany)', borderRadius: 4, padding: '2rem' }}>
              <h3 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '1.2rem', fontWeight: 600, color: 'var(--vanilla)', marginBottom: '1.2rem' }}>Quick Questions</h3>
              <div className="space-y-4">
                {[
                  ...
                  <div key={i}>
                    <p style={{ fontSize: '0.82rem', fontWeight: 500, color: 'var(--tobacco)', fontFamily: 'DM Sans, sans-serif', marginBottom: 2 }}>{faq.q}</p>
                    <p style={{ fontSize: '0.78rem', color: 'var(--sand)', fontFamily: 'DM Sans, sans-serif', fontWeight: 300 }}>{faq.a}</p>
                  </div>
                ))}
              </div>
            </div>
