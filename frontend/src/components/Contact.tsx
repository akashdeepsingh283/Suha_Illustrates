        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div style={{ backgroundColor: 'var(--vanilla)', border: '1px solid var(--sand)', borderRadius: 4, padding: 'clamp(1.5rem, 5vw, 2.5rem)' }}>
            <div className="flex items-center space-x-3 mb-6 sm:mb-8">
              ...
              <h3 style={{fontFamily: "'Playfair Display', serif", fontSize: 'clamp(1.1rem, 4vw, 1.4rem)', fontWeight: 600, color: 'var(--mahogany)' }}>Send a Message</h3>
            </div>

            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
              {/* Name + Email row — stacked on mobile */}
              <div style={{fontFamily: "'Playfair Display', serif"}} className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                {[{ id: 'name', label: 'Full Name', type: 'text', placeholder: 'Your name' },
                  ...
                  <div key={f.id}>
                    ...
                    <input
                      ...
                      style={{ ...inputStyle,fontFamily: "'Playfair Display', serif", borderColor: focusedField === f.id ? 'var(--tobacco)' : 'var(--sand)' }}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                {[
                  { id: 'project', label: 'Project Type', options: [{ v: '', l: 'Select type' }, { v: 'portrait', l: 'Portrait Commission' }, { v: 'illustration', l: 'Digital Illustration' }, { v: 'character', l: 'Character Design' },{ v: 'branding', l: 'Branding/Logo Design' }, { v: 'other', l: 'Other' }] },
                  ...
                  <div key={f.id}>
                    ...
                    <select
                      ...
                      style={{ ...inputStyle,fontFamily: "'Playfair Display', serif", borderColor: focusedField === f.id ? 'var(--tobacco)' : 'var(--sand)', appearance: 'auto' }}
                      onFocus={() => setFocusedField(f.id)} onBlur={() => setFocusedField(null)}
                    >
              ...
              <div>
                ...
                <textarea
                  ...
                  style={{ ...inputStyle, resize: 'none',fontFamily: "'Playfair Display', serif", borderColor: focusedField === 'message' ? 'var(--tobacco)' : 'var(--sand)' }}
              ...
              <button
                ...
                style={{
                 ...
                 fontFamily: "'Playfair Display', serif", fontWeight: 400, cursor: isLoggedIn ? 'pointer' : 'not-allowed',
              ...
              {!isLoggedIn && (
                <p style={{ fontSize: '0.78rem', textAlign: 'center', color: 'var(--text-muted)', fontFamily: "'Playfair Display', serif" }}>
                  You must{' '}
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div style={{ backgroundColor: 'var(--vanilla)', border: '1px solid var(--sand)', borderRadius: 4, padding: 'clamp(1.2rem, 4vw, 2rem)' }}>
              <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(1.1rem, 4vw, 1.4rem)', fontWeight: 600, color: 'var(--mahogany)', marginBottom: '1.2rem' }}>
                Contact Info
              </h3>
                ...
                {contactInfo.map((info, i) => (
                  <div key={i} className="flex items-center space-x-4">
                    ...
                    <div style={{ minWidth: 0 }}>
                      <div style={{ fontSize: '0.65rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--mountain)', fontFamily: "'Playfair Display', serif" }}>{info.title}</div>
                      <a
                        href={info.link}
                        style={{ color: 'var(--mahogany)', fontSize: 'clamp(0.78rem, 2.5vw, 0.88rem)', fontFamily: "'Playfair Display', serif", fontWeight: 400, textDecoration: 'none', wordBreak: 'break-all' }}
            ...
            <div style={{ backgroundColor: 'var(--vanilla)', border: '1px solid var(--sand)', borderRadius: 4, padding: 'clamp(1.2rem, 4vw, 2rem)' }}>
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(1.1rem, 4vw, 1.4rem)', fontWeight: 600, color: 'var(--mahogany)' }}>Availability</h3>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 12px', backgroundColor: 'rgba(181,158,125,0.1)', border: '1px solid var(--tobacco)', borderRadius: 2, marginBottom: '0.8rem', gap: 8 }}>
                <span style={{ fontSize: 'clamp(0.75rem, 2.5vw, 0.82rem)', color: 'var(--mahogany)', fontFamily: "'Playfair Display', serif" }}>Current Status</span>
                <span style={{ fontSize: '0.7rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--tobacco)', fontFamily: "'Playfair Display', serif", whiteSpace: 'nowrap' }}>Available</span>
              </div>
              <div style={{ fontSize: 'clamp(0.75rem, 2.5vw, 0.82rem)', color: 'var(--text-muted)', lineHeight: 2, fontFamily: "'Playfair Display', serif", fontWeight: 300 }}>
            ...
            <div style={{ backgroundColor: 'var(--mahogany)', borderRadius: 4, padding: 'clamp(1.2rem, 4vw, 2rem)' }}>
              <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(1rem, 4vw, 1.2rem)', fontWeight: 600, color: 'var(--vanilla)', marginBottom: '1rem' }}>Quick Questions</h3>
              <div className="space-y-3 sm:space-y-4">
                {[
                  ...
                  <div key={i}>
                    <p style={{ fontSize: 'clamp(0.75rem, 2.5vw, 0.82rem)', fontWeight: 500, color: 'var(--tobacco)', fontFamily: "'Playfair Display', serif", marginBottom: 2 }}>{faq.q}</p>
